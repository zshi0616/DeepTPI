...
//		iNoDetected=random_sim(g_iNoGate, g_iNoPI, g_iNoPO, iMaxLevelAdd2, iNoStemGates, pStemGates, \
//							   LFSR, randomlimit, iMaxBitSize, maxdetect, &ntest, &iPacket, &iBit, g_fpTestFile);
//		// printf("%d, %d, %d, %d, %d, %d \n", g_iNoGate, g_iNoPI, g_iNoPO, iMaxLevelAdd2, iNoStemGates, pStemGates);
//		// printf("%d, %d, %d, %d, %d, %d, %d \n", randomlimit, iMaxBitSize, maxdetect, ntest, iPacket, iBit, g_fpTestFile);
//		printf("[INFO] Pattern Counts : %d\n", ntest);
//		// ntest1=ntest;
...
//	}
	...
	iNoDetected += testgen(g_iNoGate, g_iNoPI, g_iNoPO, iMaxLevelAdd2, iMaxBitSize, iNoStemGates, pStemGates, g_iMaxBackTrack1,
		bPhase2, &iNoRedundant, &iNoOverBackTrack, &iNoBackTrack, &iNoTempPatterns, &iPacket, &iBit, &lfFanTime, g_fpTestFile, target_fault_coverage);
...
//			g_fpTestFile, target_fault_coverage);
...
int read_option(char option, char *array[], int i, int n)
{
	...
	case 'C':
		sscanf(array[++i], "%d", &target_fault_coverage); break;
	case 'B':

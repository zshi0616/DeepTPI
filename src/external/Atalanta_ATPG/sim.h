...
int tgen_sim(int nog, int LEVEL, int nopi, int nopo, int nstem, GATEPTR *stem, int ntest, int profile[], VEC *detected_list);
...
VEC testgen(int nog, int nopi, int nopo, int LEVEL, int maxbits, int nstem, GATEPTR *stem, int maxbacktrack, int phase, 
int *nredundant, int *noverbacktrack, int *nbacktrack, int *ntest, int *npacket, int *nbit, double *fantime, FILE *test, int *ndetect);
